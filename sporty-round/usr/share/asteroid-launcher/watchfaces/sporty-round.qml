...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.beginPath()
            ctx.moveTo(parent.width/2 + Math.cos(angle) * width * 0.28,
                       parent.height/2 + Math.sin(angle) * width * 0.28)
            ctx.lineTo(parent.width/2 + Math.cos(angle) * width * 0.43,
                       parent.height/2 + Math.sin(angle) * width * 0.43)
            ctx.stroke()
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.beginPath()
            ctx.moveTo(parent.width/2 + Math.cos(angle) * width * 0.285,
                       parent.height/2 + Math.sin(angle) * width * 0.285)
            ctx.lineTo(parent.width/2 + Math.cos(angle) * width * 0.36,
                       parent.height/2 + Math.sin(angle) * width * 0.36)
            ctx.stroke()
        }
    }
