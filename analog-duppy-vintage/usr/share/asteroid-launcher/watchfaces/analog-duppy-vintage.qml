    ...
    Item {
        ...
        Repeater {
            ...
            Text {
                ...
                x: centerX + Math.cos(rotM * 2 * Math.PI) * parent.width * .395
                y: verticalFontOffset + centerY + Math.sin(rotM * 2 * Math.PI) * parent.width * .395
                font {
        ...
        Item {
            ...
            Repeater {
                ...
                Rectangle {
                    anchors.centerIn: parent
                    width: (parent.width * .78) + (index * (parent.width * .08))
                    height: width
                    radius: width / 2
                    color: "transparent"
                    border.width: root.height * .004
                ...
                Canvas {
                    ...
                    onPaint: {
                        ...
                        ctx.arc(parent.width / 2, parent.height / 2,
                                parent.width * .39 + (index * (parent.width * .04)),
                                (arcStart + 270) * rad,
