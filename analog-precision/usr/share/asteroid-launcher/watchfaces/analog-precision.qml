...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.beginPath();
            ctx.moveTo(parent.width / 2, parent.height / 2);
            ctx.lineTo(parent.width / 2 + Math.cos((minute - 15) / 60 * 2 * Math.PI) * width * 0.32, parent.height / 2 + Math.sin((minute - 15) / 60 * 2 * Math.PI) * width * 0.32);
            ctx.stroke();
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.beginPath();
            ctx.moveTo(parent.width / 2, parent.height / 2);
            ctx.lineTo(parent.width / 2 + Math.cos((second - 15) / 60 * 2 * Math.PI) * width * 0.335, parent.height / 2 + Math.sin((second - 15) / 60 * 2 * Math.PI) * width * 0.335);
            ctx.stroke();
        }
    }
