...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            var voffset = -parent.height * 0.020
            for (var i = 1; i < 13; i++) {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.moveTo(parent.width/2 + Math.cos(((hour - 3.02  + m / 60) / 12) * 2 * Math.PI) * width * 0.31,
                       parent.height/2 + Math.sin(((hour - 3.02 + m / 60) / 12) * 2 * Math.PI) * width * 0.31)
            ctx.lineTo(parent.width/2 + Math.cos(((hour - 3.22  + m / 60) / 12) * 2 * Math.PI) * width * 0.2,
                       parent.height/2 + Math.sin(((hour - 3.22 + m / 60) / 12) * 2 * Math.PI) * width * 0.2)
            ctx.lineTo(parent.width/2 + Math.cos(((hour - 7.00  + m / 60) / 12) * 2 * Math.PI) * width * 0.01,
                       parent.height/2 + Math.sin(((hour - 7.00 + m / 60) / 12) * 2 * Math.PI) * width * 0.01)
            ctx.lineTo(parent.width/2 + Math.cos(((hour - 11    + m / 60) / 12) * 2 * Math.PI) * width * 0.01,
                       parent.height/2 + Math.sin(((hour - 11   + m / 60) / 12) * 2 * Math.PI) * width * 0.01)
            ctx.lineTo(parent.width/2 + Math.cos(((hour - 2.78  + m / 60) / 12) * 2 * Math.PI) * width * 0.2,
                       parent.height/2 + Math.sin(((hour - 2.78 + m / 60) / 12) * 2 * Math.PI) * width * 0.2)
            ctx.lineTo(parent.width/2 + Math.cos(((hour - 2.98  + m / 60) / 12) * 2 * Math.PI) * width * 0.31,
                       parent.height/2 + Math.sin(((hour - 2.98 + m / 60) / 12) * 2 * Math.PI) * width * 0.31)
            ctx.fill()
            ctx.closePath()
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.fillStyle     = Qt.rgba(1, 1, 1, 1)
            ctx.beginPath()
            ctx.moveTo(parent.width/2 + Math.cos(((m - 15.08) / 60) * 2 * Math.PI) * width * 0.41,
                       parent.height/2 + Math.sin(((m - 15.08) / 60) * 2 * Math.PI) * width * 0.41)
            ctx.lineTo(parent.width/2 + Math.cos(((m - 15.7)  / 60) * 2 * Math.PI) * width * 0.285,
                       parent.height/2 + Math.sin(((m - 15.7)  / 60) * 2 * Math.PI) * width * 0.285)
            ctx.lineTo(parent.width/2 + Math.cos(((m - 37)    / 60) * 2 * Math.PI) * width * 0.01,
                       parent.height/2 + Math.sin(((m - 37)    / 60) * 2 * Math.PI) * width * 0.01)
            ctx.lineTo(parent.width/2 + Math.cos(((m - 53)    / 60) * 2 * Math.PI) * width * 0.01,
                       parent.height/2 + Math.sin(((m - 53)    / 60) * 2 * Math.PI) * width * 0.01)
            ctx.lineTo(parent.width/2 + Math.cos(((m - 14.3)  / 60) * 2 * Math.PI) * width * 0.285,
                       parent.height/2 + Math.sin(((m - 14.3)  / 60) * 2 * Math.PI) * width * 0.285)
            ctx.lineTo(parent.width/2 + Math.cos(((m - 14.92) / 60) * 2 * Math.PI) * width * 0.41,
                       parent.height/2 + Math.sin(((m - 14.92) / 60) * 2 * Math.PI) * width * 0.41)
            ctx.fill()
            ctx.closePath()
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.lineTo(parent.width/2  + Math.cos((second - 15) / 60 * 2 * Math.PI) * width  * 0.35,
                       parent.height/2 + Math.sin((second - 15) / 60 * 2 * Math.PI) * height * 0.35)
            ctx.stroke()
            ctx.closePath()
        }
    }
