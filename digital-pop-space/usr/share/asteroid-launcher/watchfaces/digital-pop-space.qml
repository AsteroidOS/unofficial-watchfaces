...
Item {
    ...
    Item {
        ...
        Text {
            ...
            font {
                pixelSize: root.maxSize * 0.061
                family: "Baloo Tammudu 2"
                styleName: "Light"
                letterSpacing: -root.maxSize * 0.0034
            }
        ...
        Text {
            ...
            font {
                pixelSize: root.maxSize * 0.16
                family: "outrun future"
                styleName: "Regular"
                letterSpacing: -root.maxSize * 0.002
            }
