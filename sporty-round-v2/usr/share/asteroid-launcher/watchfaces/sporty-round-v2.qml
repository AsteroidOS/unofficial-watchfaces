    ...
    Item {
        ...
        Canvas {
            ...
            onPaint: {
                ...
                gradient.addColorStop(0.4, Qt.rgba(0.996, 0.259, 0.051, 0));
        ...
        Canvas {
            ...
            onPaint: {
                ...
                gradient.addColorStop(0.38, Qt.rgba(0, 0.937, 0.937, 0));
                gradient.addColorStop(0.95, Qt.rgba(0, 0.937, 0.937, 1));
                ctx.strokeStyle = gradient;
                ctx.moveTo(parent.width / 2, parent.height / 2);
                ctx.lineTo(parent.width / 2 + Math.cos((second - 15) / 60 * 2 * Math.PI) * width * 0.46, parent.height / 2 + Math.sin((second - 15) / 60 * 2 * Math.PI) * width * 0.46);
                ctx.stroke();
                ctx.closePath();
            }
        }
        ...
        Canvas {
            ...
            onPaint: {
                ...
                gradient.addColorStop(0.39, Qt.rgba(0.996, 0.969, 0.051, 0));
                gradient.addColorStop(0.95, Qt.rgba(0.996, 0.969, 0.051, 1));
                ctx.strokeStyle = gradient;
                ctx.moveTo(parent.width / 2, parent.height / 2);
                ctx.lineTo(parent.width / 2 + Math.cos((minute - 15) / 60 * 2 * Math.PI) * width * 0.41, parent.height / 2 + Math.sin((minute - 15) / 60 * 2 * Math.PI) * width * 0.41);
                ctx.stroke();
                ctx.closePath();
            }
        }
        ...
        Canvas {
            ...
            onPaint: {
                ...
                var gradient = ctx.createRadialGradient(parent.width / 2, parent.height / 2, 0, parent.width / 2, parent.height / 2, parent.width * 0.46);
                gradient.addColorStop(0.39, low ? Qt.rgba(1, 0, 0, 0) : Qt.rgba(0.318, 1, 0.051, 0));
