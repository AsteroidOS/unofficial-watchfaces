...
Item {
    ...
    Image {
        ...
        z: 1
        opacity: 0.96
        sourceSize: Qt.size(root.width * 0.22, root.height * 0.22)
        source: imagePath + wallClock.time.toLocaleString(Qt.locale(), "dd").toUpperCase().slice(0, 1) + "-num.svg"
        layer.enabled: true

        anchors {
            centerIn: parent
            verticalCenterOffset: parent.width * 0.012 + verticalDateOffset
            horizontalCenterOffset: -parent.width * 0.232 + horizontalDateOffset
        }
    ...
    Image {
        ...
        anchors {
            centerIn: parent
            verticalCenterOffset: parent.width * 0.012 + verticalDateOffset
            horizontalCenterOffset: -parent.width * 0.17 + horizontalDateOffset
        }
    ...
    Image {
        ...
        anchors {
            centerIn: parent
            verticalCenterOffset: parent.width * 0.114 + verticalDateOffset
            horizontalCenterOffset: -parent.width * 0.232 + horizontalDateOffset
        }
    ...
    Image {
        ...
        source: use12H.value ? imagePath + wallClock.time.toLocaleString(Qt.locale(), "hh ap").slice(0, 1) + "-num.svg" : imagePath + wallClock.time.toLocaleString(Qt.locale(), "HH").slice(0, 1) + "-num.svg"
        layer.enabled: true
            ...
            SequentialAnimation {
                ParallelAnimation {
                    NumberAnimation {
                        ...
                        to: -parent.height + verticalFontOffset
                        duration: 1000
                    ...
                    NumberAnimation {
                        ...
                        to: -parent.width + horizontalFontOffset
                        duration: 1000
                        easing.type: Easing.InCubic
                    }
                ...
                ParallelAnimation {
                    NumberAnimation {
                        target: topLeft
                        property: "anchors.bottomMargin"
                        to: topbottomMargin + verticalFontOffset
                        duration: 1000
                    ...
                    NumberAnimation {
                        target: topLeft
                        property: "anchors.rightMargin"
                        to: leftrightMargin + horizontalFontOffset
                        duration: 1000
                        easing.type: Easing.OutCubic
                    }
    ...
    Image {
        ...
        z: 10
        sourceSize: numeralSize
        source: use12H.value ? imagePath + wallClock.time.toLocaleString(Qt.locale(), "hh ap").slice(1, 2) + "-num.svg" : imagePath + wallClock.time.toLocaleString(Qt.locale(), "HH").slice(1, 2) + "-num.svg"
        layer.enabled: true
    ...
    Image {
        ...
        visible: false
        sourceSize: numeralSize
        source: use12H.value ? imagePath + wallClock.time.toLocaleString(Qt.locale(), "hh ap").slice(0, 1) + "-trail.svg" : imagePath + wallClock.time.toLocaleString(Qt.locale(), "HH").slice(0, 1) + "-trail.svg"
    ...
    Image {
        ...
        visible: false
        sourceSize: numeralSize
        source: use12H.value ? imagePath + wallClock.time.toLocaleString(Qt.locale(), "hh ap").slice(1, 2) + "-trail.svg" : imagePath + wallClock.time.toLocaleString(Qt.locale(), "HH").slice(1, 2) + "-trail.svg"
    ...
    LinearGradient {
        ...
        anchors.fill: parent
        visible: false
        start: Qt.point(parent.width * 0.24, parent.height * 0.24)
        end: Qt.point(parent.width * 0.7, parent.height * 0.7)

        gradient: Gradient {
            GradientStop {
                position: 0
                color: colorSchemes[randomScheme][0]
    ...
    LinearGradient {
        ...
        visible: false
        start: Qt.point(parent.width * 0.24, parent.height * 0.24)
        end: Qt.point(parent.width * 0.8, parent.height * 0.8)

        gradient: Gradient {
            GradientStop {
                position: 0
                color: colorSchemes[randomScheme][1]
    ...
    LinearGradient {
        ...
        visible: false
        start: Qt.point(parent.width * 0.24, parent.height * 0.24)
        end: Qt.point(parent.width * 0.6, parent.height * 0.6)

        gradient: Gradient {
            GradientStop {
                position: 0
                color: colorSchemes[randomScheme][2]
    ...
    LinearGradient {
        ...
        gradient: Gradient {
            GradientStop {
                position: 0
                color: colorSchemes[randomScheme][3]
