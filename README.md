...
| analog-nordic - [FatCow](analog-nordic/usr/share/fonts/) | According to fontspace.com, the font "FatCow" is licensed under SIL Open Font License and was created by [Samantha Evans](http://www.fontspace.com/samantha-evans). [license](http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)|
| alternative-scifi-mosen - [Xolonium](alternative-scifi-mosen/usr/share/fonts/) | The font "Xolonium" is licensed under SIL Open Font License and was created by Severin Meyer. [license](alternative-scifi-mosen/usr/share/fonts/LICENSE.txt)|
