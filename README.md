...
| analog-lucida - [EB Garamond](analog-lucida/usr/share/fonts/) | The font "EB Garamond" is licensed under SIL Open Font License and was created by [Georg Duffner and Octavio Pardo](https://github.com/octaviopardo/EBGaramond12). [license](https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL) |
| analog-sundial - [JetBrains Mono](analog-sundial/usr/share/fonts/) | The font "JetBrains Mono" is licensed under SIL Open Font License and was created by [JetBrains](https://www.jetbrains.com/lp/mono/). [license](https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL) |
