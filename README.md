...
- After cloning the repo and changing into its local directory like described above, make the testing script executable.\
`sudo chmod +x test-in-qmlscene.sh`
- Execute it without flag to use 24H display.\
`./test-in-qmlscene.sh`
