// SPDX-FileCopyrightText: 2022 David Rinehart <wdaver@cox.net>
...
Item {
        ...
        Rectangle {
            ...
            color: {
                if (displayAmbient)
                    ...
                    ((hours > 6 && hours < 18) ? "black" : "whitesmoke");
            }
            width: {
                if (index % 5)
                    (parent.width * 0.0055);
    ...
    Repeater {
        ...
        Rectangle {
            ...
            visible: !displayAmbient
            antialiasing: true
            x: centerX + Math.cos(rotM * 2 * Math.PI) * parent.width * 0.2
            y: centerY + Math.sin(rotM * 2 * Math.PI) * parent.width * 0.2
            color: "#55111111"
